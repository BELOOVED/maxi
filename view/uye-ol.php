...
<!-- Mirrored from wwwjojobet632.com/uye-ol.php by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Oct 2022 16:23:37 GMT -->
...
<script src="dosya/app.js?v=5"></script>
...
<source srcset="8c3abcf5-gizli-uyelik-mobile-1.jpg" media="(max-width: 1099px)">
<source srcset="38e0292a-gizli-uyelik-1.jpg">
<img alt="" class="PictureImg LazyImage" src="38e0292a-gizli-uyelik-1.jpg" width="460" height="1000"></picture>
</figure>
</div>
...
<form class="Form" method="post" action="javascript:;" id="register_form" onsubmit="signUp()">
...
<div class="InputWrap">
<input type="text" name="field_first" required="">
</div>
</label>
<label class="InputContainer FormLabel ">
<div class="LabelWrap"><span><span class="LabelText">Şifre</span><span class="Req">*</span></span></div>
<div class="InputWrap">
<input type="password" name="field_second" required="">
<span class="PasswordToggleIcon OpenEye"></span></div>
</label>
<label class="InputContainer FormLabel ">
...
<button type="submit" class="RegisterFormSubmitButton"><span>Şimdi Kayıt Olun!*</span></button>
</form>
</div>
</div>
