					  ...
					  <div class="swiper-wrapper smooth-translate" style="--columnWidth:375px; --noOfColumns:7; --columnWidthPercentage:14.2857%; width: 700%; transform: translate3d(0%, 0px, 0px);">
						  ...
						  <div class="content-wrapper">
							...
							<div class="slider-info">
							  <div class="slider-text">
								<span class="banner-title">1500 TL + 150 Freespin Hoşgeldin Paketi</span>
								<!---->
								<!---->
							  </div>
						...
						<div class="swiper-slide" style="background-image: url(&quot;https://cdnroute.bpsgameserver.com/bgr/CasinoMaxi/Common/tr/image/2022/10/ba99c43f617e4765b87d4a1dd50230da.jpg&quot;);">
						  <div class="content-wrapper">
							...
							<div class="slider-info">
							  <div class="slider-text">
								<span class="banner-title">Hafta Sonu Özel Slotlarda Kazan</span>
								<!---->
								<!---->
							  </div>
							  <div class="buttons-holder">
							  ...
							  <casino-game-collection class="ng-tns-c187-0">
								<section class="games-section content-wrapper ng-tns-c187-0 ng-star-inserted" test-id="yeni-oyunlar-collection">
								  <div class="game-category-header row ng-tns-c187-0">
									...
									<div class="col-md-5 collection-select ng-tns-c187-0 col-md-2 col-xs-12 offset-md-5">
								  ...
								  <section class="games-collection-section ng-tns-c187-0" test-id="yeni-oyunlar-content">
									...
									<ul class="games-list-wrapper ng-tns-c187-0 ng-animate-disabled" test-id="undefined-collection">
									  ...
									  <li class="game-container ng-tns-c187-0 ng-trigger ng-trigger-thumbnailEnterLeave ng-star-inserted">
										<obg-casino-game-thumbnail class="game-wrapper ng-tns-c187-0">
										  <div test-id="game-thumbnail" class="game-thumbnail" game-id="relax9KKongInVegas">
											<game-favourite class="ng-star-inserted" style="">
											  <div class="game-favourite">
												<!---->
												<input type="checkbox" class="favourite-checkbox" test-id="favourite-button">
											...
											<a uisref="game" href="/tr/slot-oyunlari/9k-kong-in-vegas/" class="ng-star-inserted" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<!---->
												<img class="thumbnail-img ng-star-inserted" alt="9K Kong In Vegas" src="https://cdnroute.bpsgameserver.com/common/Common/Common/neutral/image/2022/11/game.relax9KKongInVegas.thumbnail.344x220.jpg">
												<!---->
												<!---->
											  </div>
											  <!---->
											  ...
											  <section>
												<div class="ng-star-inserted">
												  <span test-id="game-name" class="game-name">9K Kong In Vegas</span>
												</div>
												<!---->
												<!---->
											  </section>
									  ...
									  <li class="game-container ng-tns-c187-0 ng-trigger ng-trigger-thumbnailEnterLeave ng-star-inserted">
										<obg-casino-game-thumbnail class="game-wrapper ng-tns-c187-0">
										  <div test-id="game-thumbnail" class="game-thumbnail" game-id="leanderForceOfNature">
											<game-favourite class="ng-star-inserted" style="">
											  <div class="game-favourite">
												<!---->
												<input type="checkbox" class="favourite-checkbox" test-id="favourite-button">
											...
											<a uisref="game" href="/tr/slot-oyunlari/force-of-nature/" class="ng-star-inserted" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<!---->
												<img class="thumbnail-img ng-star-inserted" alt="Force of Nature" src="https://cdnroute.bpsgameserver.com/common/Common/Common/neutral/image/2019/06/game.leanderForceOfNature.thumbnail.344x220.jpg">
												<!---->
												<!---->
											  </div>
											  <!---->
											  ...
											  <section>
												<div class="ng-star-inserted">
												  <span test-id="game-name" class="game-name">Force of Nature</span>
												</div>
												<!---->
												<!---->
											  </section>
									  ...
									  <li class="game-container ng-tns-c187-0 ng-trigger ng-trigger-thumbnailEnterLeave ng-star-inserted">
										<obg-casino-game-thumbnail class="game-wrapper ng-tns-c187-0">
										  <div test-id="game-thumbnail" class="game-thumbnail" game-id="reevoMonkeyMania">
											<game-favourite class="ng-star-inserted" style="">
											  <div class="game-favourite">
												<!---->
												<input type="checkbox" class="favourite-checkbox" test-id="favourite-button">
											...
											<a uisref="game" href="/tr/slot-oyunlari/monkey-mania/" class="ng-star-inserted" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<!---->
												<img class="thumbnail-img ng-star-inserted" alt="Monkey Mania" src="https://cdnroute.bpsgameserver.com/common/Common/Common/neutral/image/2022/08/game.reevoMonkeyMania.thumbnail.344x220.jpg">
												<!---->
												<!---->
											  </div>
											  <!---->
											  ...
											  <section>
												<div class="ng-star-inserted">
												  <span test-id="game-name" class="game-name">Monkey Mania</span>
												</div>
												<!---->
												<!---->
											  </section>
								...
								<section class="games-section content-wrapper ng-tns-c187-1 ng-star-inserted" test-id="recommendedPromotedGames-collection">
								  ...
								  <section class="games-collection-section ng-tns-c187-1" test-id="recommendedPromotedGames-content">
									...
									<ul class="games-list-wrapper ng-tns-c187-1 ng-animate-disabled" test-id="undefined-collection">
											...
											<a uisref="game" class="jackpot-active ng-star-inserted" href="/tr/jackpotlar/hall-of-gods/" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<div class="icon-jackpots jackpot ng-star-inserted">
												  <span>
													<span class="jackpot-value"> ₺93.650.998 </span>
												  </span>
												</div>
												<!---->
										  ...
										  <div test-id="game-thumbnail" class="game-thumbnail" game-id="MegaJackpot">
											...
											<a uisref="game" class="jackpot-active ng-star-inserted" href="/tr/jackpotlar/mega-fortune/" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<div class="icon-jackpots jackpot ng-star-inserted">
												  <span>
													<span class="jackpot-value"> ₺49.799.727 </span>
												  </span>
												</div>
												<!---->
									  ...
									  <li class="game-container ng-tns-c187-1 ng-trigger ng-trigger-thumbnailEnterLeave ng-star-inserted">
										<obg-casino-game-thumbnail class="game-wrapper ng-tns-c187-1">
										  <div test-id="game-thumbnail" class="game-thumbnail" game-id="GonzosQuest">
											<game-favourite class="ng-star-inserted" style="">
											  <div class="game-favourite">
												<!---->
												<input type="checkbox" class="favourite-checkbox" test-id="favourite-button">
											...
											<a uisref="game" href="/tr/slot-oyunlari/gonzos-quest/" class="ng-star-inserted" style="">
											  <div test-id="game-image" lazy-load-images="" class="game-image">
												...
												<!---->
												<img class="thumbnail-img ng-star-inserted" alt="play Gonzo's Quest" src="https://cdnroute.bpsgameserver.com/common/Common/Common/neutral/image/2020/06/game.GonzosQuest.thumbnail.344x220_v4.jpg">
												<!---->
												<!---->
											  </div>
											  <!---->
											  ...
											  <section>
												<div class="ng-star-inserted">
												  <span test-id="game-name" class="game-name">Gonzo's Quest</span>
												</div>
												<!---->
												<!---->
											  </section>
		...
		<master-footer>
		  <footer class="master-footer clearfix">
			...
			<section class="footer-variant-two-legal">
			  <div class="content-align">
				<section class="footer-legal-text col-lg-8">
				  <footer-legal-text>
				...
				<section class="footer-licenses-logos col-lg-4">
