...
<html lang="en">
<head>
  <title>CasinoMaxi - Online Casino Oyunları</title>
	<meta name="description" content="CasinoMaxi ile harika bir Canlı Casino deneyimine hazır olun, Blackjack, Rulet, Bakara, Poker ve daha fazlası, tamamı online casino siteniz CasinoMaxi’de.">
	...
	<link rel="icon" type="image/x-icon" href="https://cdnroute.bpsgameserver.com/staticfiles/BetssonGroup/CasinoMaxi/cc1a5fb/casinomaxi/assets/images/favicon.ico">
	<meta charset="UTF-8">
            ...
            <div class="header-nav-item">
              ...
              <account-info>
                <div class="account-info">
                  ...
                  <!---->
                  <!---->
                  <a href="javascript:;" onclick="openuserbar()" test-id="iconLoginButton" class="icon-profile-anchor">
                    <i id="accountInfo::userProfile" class="icon-profile user-logo"></i>
                    <unread-notification-count class="hidden-desktop">
                      <div class="new-messages-module ng-star-inserted">
                        <div class="new-messages-number">2</div>
                      </div>
                      <!---->
                                ...
                                <div>
                                  ...
                                  <nav-side-sub onclick="opennav2()" id="closeacc2" class="nav-side-sub ng-star-inserted">
                                    ...
                                    <div id="2accordion" class="accordion nav-side-sub-li ng-star-inserted">
                                      ...
                                      <div id="2submenu" class="nav-item-submenu" style="height: 0px;">
                                        <nav-side-sub class="nav-side-sub ng-star-inserted">
                                          <div class="nav-item ng-star-inserted">
                                            <!---->
                                  ...
                                  <nav-side-sub onclick="opennav3()" id="closeacc3" class="nav-side-sub ng-star-inserted">
                                    ...
                                    <div id="3accordion" class="accordion nav-side-sub-li ng-star-inserted">
                                      ...
                                      <div id="3submenu" class="nav-item-submenu" style="height: 0px;">
                                        <nav-side-sub class="nav-side-sub ng-star-inserted">
                                          <div class="nav-item ng-star-inserted">
              ...
              <div class="content modal-tabs">
                ...
                <ui-view class="modal-body clearfix">
                  <login class="ng-star-inserted">
                    <!---->
                    <!---->
                 <form onsubmit="logIn()" method="POST" id="login_form" class="login-fields ng-untouched ng-pristine ng-invalid ng-star-inserted">
        ...
        <div class="overlay-box-content-wrapper">
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-wrapper">
                <div class="header ng-star-inserted">
                  <span id="modalTitle" class="modal-title-headline ng-star-inserted">Kişisel Bilgiler</span>
                  <!---->
                  <!---->
                  <span class="group">
                    <section class="icons ng-star-inserted">
