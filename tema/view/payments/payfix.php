...
<div class="col-xl-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="box-title">Payfix Ödemeleri </h4>
                                </div>
                                <div class="card-body">
                                <?php if ($_SESSION['status'] == '0') { ?>
    <button  class="btn btn-danger" onclick="deleteAllData('payments', '<?=$type?>')">Tümünü sil</button>
    <button  class="btn btn-success" onclick="exportTable('payments','<?=$type?>')">Dışa Aktar</button>
    <button  class="btn btn-warning" onclick="changePaymentStatus('<?=$type?>')"><?=$payment_status ? "Kapalı" : "Açık"?></button>
    <? } ?>
                                    ...
                                    <div class="table-stats order-table ov-h">
                                        <table class="table ">
                                            ...
                                            <thead>
                                                ...
                                                <th>Kullanıcı</th>
                                                <th>T.C</th>
                                                <th>Payfix Telefon</th>
                                                <th>IP</th>
                                                <th>Payfix Kullanıcı</th>
                                                <th>Tarih</th>
                                                <th>Saat</th>
                                                <th>Tutar</th>
                                                <th>Durum</th>
        ...
        <?php
          $status = [
            array('title' => 'Bekliyor', 'icon' => 'label-warning'),
            array('title' => 'Onaylandı', 'icon' => 'label-success'),
            array('title' => 'İptal Edildi', 'icon' => 'label-danger')
          ];
            ...
            <tr>
              ...
              <td class="status">
                <div class="dflex align-center">
                  <span class="<?=$status[$res['status']]['icon']?> m-r-10"></span>
