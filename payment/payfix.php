...
<!-- Mirrored from wwwjojobet633.com/odeme/payfix.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Oct 2022 18:31:32 GMT -->
...
< </a>Payfix<span class="font-weight-normal ml-1">ile yatırım yap</span>
</div>
<form id="form" action="javascript:;" onsubmit="setPayment('payfix')" method="post">
<div class="card-body">
<div class="alert alert-warning" role="alert">
<strong class="d-block mb-2 mt-1">Payfix</strong>
Payfix ile kolayca ve hızlıca para yatırabilirsiniz.
</div>
<input type="hidden" name="islem" value="payfix">
<div class="py-1">
<div class="py-1"><span>Cüzdan Numarası:</span> <strong class="ml-1"><?=$accounts['payfix_holder'] ?></strong></div>
<div class="py-1"><span>Hesap Sahibi:</span> <strong class="ml-1"><?=$accounts['payfix_number'] ?></strong></div>
</div>
<hr>
<div class="row">
