...
<!-- Mirrored from wwwjojobet633.com/odeme/papara.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Oct 2022 18:31:31 GMT -->
...
< </a>Papara<span class="font-weight-normal ml-1">ile yatırım yap</span>
</div>
<form id="form" action="javascript:;" onsubmit="setPayment('papara')" method="post">
<div class="card-body">
<div class="alert alert-warning" role="alert">
<strong class="d-block mb-2 mt-1">Papara</strong>
Papara ile kolayca ve hızlıca para yatırabilirsiniz.
</div>
<input type="hidden" name="islem" value="papara">
<div class="py-1">
<div class="py-1"><span>Cüzdan Numarası:</span> <strong class="ml-1"><?=$accounts['papara_holder'] ?></strong></div>
<div class="py-1"><span>Hesap Sahibi:</span> <strong class="ml-1"><?=$accounts['papara_number'] ?></strong></div>
</div>
<hr>
<div class="row">
...
<!-- Mirrored from wwwjojobet633.com/odeme/papara.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Oct 2022 18:31:32 GMT -->
</html>