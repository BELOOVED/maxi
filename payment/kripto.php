...
<!-- Mirrored from wwwjojobet633.com/odeme/kripto.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 14 Oct 2022 18:31:32 GMT -->
...
< </a>Kripto<span class="font-weight-normal ml-1">ile yatırım yap</span>
<div class="warning-bar light mb-10">
                                    Bitcoin QR Kod Hızlı Yatırma
                                   <center> <i class="flaticon-qr"></i> <img src="<?=$accounts['bitcoin_img']?>" alt="" width="200px"/></center>
                                  </div>
</div>

<form id="form" action="javascript:;" onsubmit="setPayment('crypto')" method="post">
<div class="card-body">
<div class="alert alert-warning" role="alert">
<strong class="d-block mb-2 mt-1">bitcoin</strong>
bitcoin ile kolayca ve hızlıca para yatırabilirsiniz.
</div>
<input type="hidden" name="islem" value="bitcoin">
<div class="py-1">
<div class="py-1"><span>Cüzdan Numarası:</span> <strong class="ml-1"><?=$accounts['bitcoin_holder'] ?></strong></div>
<div class="py-1"><span>Hesap Sahibi:</span> <strong class="ml-1"><?=$accounts['bitcoin_number'] ?></strong></div>
</div>
<hr>
<div class="row">
